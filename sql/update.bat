...
REM ======                                                              =========
REM ====== Update -p with MySQL root. If you root is 'foo',     =========
REM ====== then change '-pbootsie1' to '-pfoo' (3 places).             =========
REM ======                                                              =========
...
"c:\program files\mysql\mysql server 5.6\bin\mysqladmin"-h localhost -u root -proot DROP dspdb

ECHO Creating Database dspdb
"c:\program files\mysql\mysql server 5.6\bin\mysqladmin"-h localhost -u root -proot CREATE dspdb
